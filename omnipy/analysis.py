...
class analysis:
    ...
    def fitting_before (self,peak_number_after_discharge,df,frqY):
        #BEFORE DISCHARGE
        #TIMESTAP DEFINITION
        timeStart1=-3
        timeStop1=-0.2
    ...
    def Raw_Data_Collection(self,disp_sensor,step,freqLaser, ax, cx):
        ...
        (x_fit_1, x_fit_2, coeffs1, coeffs2, B, inst,timeStart1, timeStop2)= self.fitting_before(x+1,df,frqY)
        
        mp= 5e-6
        L = 0.1
        
        bit = self.Ibit(mp,L,B)
